...
const Map = () => {
    ...
    useEffect(() => {
        ...
        const marker = L.marker([-23.513860, -46.597593]).addTo(map);
        ...
        var polylinePath = L.polyline(latLngs, {color: 'red'}).addTo(map).bindPopup('A pretty CSS3 popup.<br> Easily customizable.');

        // fit the map to the bounds of the polyline
        map.fitBounds(polylinePath.getBounds());
    }, []);
